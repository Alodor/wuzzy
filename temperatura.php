...
<html lang="es">
    <head>
        ...
        <meta name="keywords" content="conversor de unidades de masa">
        <meta name="description" content="Convertir unidades de temperatura.">
        <link rel="shortcut icon" href="images/favicon.ico" type="image/x-icon">
        <link href="css/style.min.css" rel="stylesheet">
        <link href="http://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/materialize/0.97.7/css/materialize.min.css">
        <link href="https://fonts.googleapis.com/css?family=Orbitron" rel="stylesheet">
        <title>Wuzzy | Unidades de Temperatura</title>
    </head>
    ...
    <body>
       ...
       <!-- Trigger menu -->
        ...
        function only_number(e) { 
            ...
            if ((tecla < 48 || tecla > 57) && tecla != 46 && tecla != 13 && tecla != 45) {
                return false 
            }                    
        }
        </script>
